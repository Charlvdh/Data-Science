...
chords, abstract_grammars = get_musical_data('gdrive/My Drive/Data Science/LSTM_network/data/original_metheny.mid')
...
def generate_music(inference_model, corpus = corpus, abstract_grammars = abstract_grammars, tones = tones, tones_indices = tones_indices, indices_tones = indices_tones, T_y = 10, max_tries = 1000, diversity = 0.5):
    ...
    mf.open("gdrive/My Drive/Data Science/LSTM_network/data/my_music.midi", 'wb')
    mf.write()
    print("Generated music is saved in data/my_music.midi")
    mf.close()
